            ...
            >
              <article>
                <div className={styles.listItemWrapper}>
                  ...
                  <p className={styles.copy_italic}>
                    "Build and maintain responsive websites and email
                    campaigns".
                  </p>
                  <ul className={styles.copy}>
                    <li>
                    ...
                    <li>Responsive email campaign development</li>
              ...
              <article>
                <div className={styles.listItemWrapper}>
                  ...
                  <p className={styles.copy_italic}>
                    "Produce, modify and maintain website and web application
                    user interfaces".
                  </p>
                  <ul className={styles.copy}>
                    <li>Front-end web development with HTML, CSS and jQuery</li>
              ...
              <article>
                <div className={styles.listItemWrapper}>
                  ...
                  <p className={styles.copy_italic}>
                    "Provide technical support for all I.T systems at the
                    Ministry of Justice's Auckland Collections Contact Centre
                    and District Courts".
                  </p>
                  <ul className={styles.copy}>
                    <li>Desktop/network support</li>
                    <li>Application configuration and maintenance</li>
                    <li>Remote administration</li>
                    <li>After hours support</li>
                    <li>Multimedia development</li>
                    <li>Technical document writing.</li>
                  </ul>
                </div>
              </article>
            </div>
                ...
                {Array.from({ length: TOTAL }, (_, i) => (
                  <button
                    ...
                    className={`${styles.sliderDot} ${
                      i === currentIndex ? styles.sliderDotActive : ''
                    }`}
                    onClick={() => goTo(i)}
                    aria-label={`Go to slide ${i + 1}`}
                  >
                    <FontAwesomeIcon icon={i === currentIndex ? faCircleDot : faCircle} />
                  </button>
                ))}
              </div>
              <button
