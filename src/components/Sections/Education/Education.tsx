...
const Education = () => {
  return (
    <section className={styles.education}>
      ...
      <div>
        <div className={styles.resumeEducation__grid}>
          <div
            className={`${styles.resumeEducation__col} ${styles.resumeEducation__col__mds}`}
          >
            <div>
              <img
          ...
          <div
            className={`${styles.resumeEducation__col} ${styles.resumeEducation__col__mit}`}
          >
            <h3 className={styles.resumeEducation__headerSub}>
            ...
            <div>
              <details className={styles.resumeEducation__details}>
                ...
                <ul className={styles.resumeEducation__detailsList}>
                  ...
                  <li className={styles.resumeEducation__detailsListItem}>
                    <span>EC310 - E-commerce Website Design (Merit Pass)</span>
                  </li>
                  <li className={styles.resumeEducation__detailsListItem}>
                    <span>PJ300 - Project</span>
                  </li>
              ...
              <details className={styles.resumeEducation__details}>
                ...
                <ul className={styles.resumeEducation__detailsList}>
                  <li>
                    <details className={styles.resumeEducation__detailsLevel2}>
                      <summary
                        className={styles.resumeEducation__summaryLevel2}
                      >
                        Database Management Systems 1 (cluster)
                      </summary>
                      <ul className={styles.resumeEducation__detailsListLevel2}>
                        <li
                          className={
